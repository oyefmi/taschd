...
/**
 * Tests of the {@link GenerateAssignment} class.
 *
 * @author nikhil
 * @author Matthew
 */
public class GenerateAssignmentTest {
	...
	public void test() {
		...
		skillSet1.addSkill(new Skill("ASP.NET"));
		...
		TimeInterval er6 = new TimeInterval(DayOfWeek.WEDNESDAY, 14, 10, 50);
		emw3.add(er6);
		...
		pool1.get(0).getCourse().getSkills().addSkill(new Skill("C++"));
		pool1.get(0).getCourse().getSkills().addSkill(new Skill("Java"));
		pool1.get(0).getCourse().getSkills().addSkill(new Skill("SQL"));
		...
		pool1.get(1).getCourse().getSkills().addSkill(new Skill("Alloy"));
		pool1.get(1).getCourse().getSkills().addSkill(new Skill("Perl"));
		...
		tm.add(vv);
		tm.add(bb);
		Section p2 = new Section("Lec", "011", "Harvey", 38, 40, "GOR118", new WeeklySchedule(tm));
		p2.setMtac(true);
		p2.setNumOfLA(0);
		p2.setNumOfTA(1);
		...
		pool1.get(2).getCourse().getSkills().addSkill(new Skill("Ruby"));
		pool1.get(2).getCourse().getSkills().addSkill(new Skill("Fortran"));
		pool1.get(2).getCourse().getSkills().addSkill(new Skill("Perl"));
		...
		hh.add(qw);
		hh.add(wq);
		Section q = new Section("Lec", "011", "Carberry", 35, 35, "SHL120", new WeeklySchedule(hh));		
		q.setNumOfLA(0);
		q.setNumOfTA(1);
		q.setMtac(false);
		...
		pool1.get(3).getCourse().getSkills().addSkill(new Skill("OpenCV"));
		pool1.get(3).getCourse().getSkills().addSkill(new Skill("Python"));
		pool1.get(3).getCourse().getSkills().addSkill(new Skill("ASP.NET"));
		...
		pool1.get(4).getCourse().getSkills().addSkill(new Skill("Bash"));
	    ...
	    gen.assign().displayAll(System.out);
