...
public class UserInterface {
	...
	public final static void main(String[] args) throws IOException, ParseException {
		...
		case "addca":
			...
			// String term = args[3] (Ex: 2188)
			String userId =  System.console().readLine("Enter your udel id: ");
			char[] passwordArray = System.console().readPassword("Enter your udel password: ");
	     //   char[] passcodeArray = System.console().readPassword("Enter your passcode: ");
